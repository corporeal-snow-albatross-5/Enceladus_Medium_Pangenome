...
ggplot(data = filtered_samples) +
  geom_raster(aes(x = SAMPLE_ORDER, y = FUNCTION_ORDER,
  fill = scale(data$Presence.Absence, center = TRUE, scale = FALSE)), hjust=0, vjust=0) + 
  labs(x = "Genome", y = "Function") + ggtitle("Presence/Absence Enceladus Pangenome") +
...
ggsave(filename = "/Users/sabrinaelkassas/Downloads/30C_hm_Nov323.svg", height = 20, width = 20)
ggsave(filename = "/Users/sabrinaelkassas/Downloads/30C_hm_Nov323.png", height = 20, width = 20)

levels(annotation_long_factored$GENE_ORDER)
```
